var appendData, evenOdd, valIdPairs;
valIdPairs = {};
evenOdd = "even";
appendData = false;
this.Prometheus = {
  ...
  getEditableInput: function(ele, val, name, change, blur) {
    var input;
